...
%% 3x1 Figure: both abus and isotiopes in 1 Figure
figure
...
printfilename = [datafile(1:end-4),'_',numbtxt,'carriers_',expstxt,'Exps_abu+iso'];
% print('-dtiff',[printfilename,'.tiff']);
print('-depsc', printfilename);
% print('-depsc', ['output/', printfilename]);


%% Both bioturbated isotope in one Fig
if(false)
figure, hold on
for i = 1:exps           
    plot(1:lngth,bioiso(i,:,1), 'Color', [0.5 0.5 0.5],'Linewidth',1.5)
...
%%
printfilename = [datafile(1:end-4),'_',numbtxt,'carriers_',expstxt,'Exps_fig2_abu+iso'];
print('-depsc', printfilename);
% print('-depsc', ['output/',printfilename]);
...
%printfilename = ['turbo2_fig1_',mxltext,'cm_',numbtxt,'carriers.tiff'];
printfilename = [datafile(1:end-4),'_',numbtxt,'carriers_',expstxt,'Exps_fig1_abu+iso'];
% print('-dtiff',[printfilename,'.tiff']);
print('-depsc', printfilename);
% print('-depsc', ['output/', printfilename]);
end
